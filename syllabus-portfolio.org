...
+ read assigned portions of the course materials /before/ class each Monday and Friday.
...
These readings are to be completed *prior to* each listed week\rsquo{}s Wednesday. The
exercises from each chapter (all of them) are to be completed *prior to* close-of-day each
Friday.
...
Note: Currently, you see full credit for week one\rsquo{}s work. (\checkmark means yes. Blank means no.) Update the 
table for week 1 and all subsequent weeks each class day and week during the semester.
...
Course Tracker acronyms and their meanings.
	...
	+ SAQ - I submitted /at least 1/ appropriate, Significant, al Question I have regarding the information for this week.
...
| / | <>         | <>          | <>               | <>             |
|---+------------+-------------+------------------+----------------|
| # | Claim Week | Grade Claim | Instructor Grade | usted Grade |
|---+------------+-------------+------------------+----------------|
| # | 5          |             |                  |                |
|---+------------+-------------+------------------+----------------|
| # | 9          |             |                  |                |
